		...
		<div class="main_wrapper">
			...
			<hr style="margin:0; height:2px; background-color: black; border:none">
				...
				<div class="navbar">
					...
					<form action="change_name.php" method="post" enctype="multipart/form-data" style="font-family: Arial, Helvetica, sans-serif;">

						<b style="padding-left: 500px">Enter New Name: </b><input type = "text" name = "new_name" ><br>
						...
						<br>
						<br>
						<center><input type = "submit" name="change_name" value = "Change Name"></center>						
...
<?php
					...
					if(isset($_POST['change_name']))
					{
						...
						$old_name = $_SESSION['customer_name'];
						...
						{*/
							$update_name = "update customers set customer_name='$new_name' where customer_id='$user'";

							$run_update = mysqli_query($con, $update_name);

							

							echo "<script>alert('Your Name was updated successfully!')</script>";
							echo "<script>alert('old name: $old_name')</script>";
							echo "<script>alert('new name: $new_name')</script>";
