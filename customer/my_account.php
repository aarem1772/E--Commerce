			...
			<hr style="margin:0; height:2px; background-color: black; border:none">
				...
				<div class="navbar">
  				...
  				<?php
  					...
  					$get_data = "select * from customers where customer_id = '$user'";
 					$run_data = mysqli_query($con, $get_data);

 					$row_data = mysqli_fetch_array($run_data);

 					$c_name = $row_data['customer_name'];

 					$c_email = $row_data['customer_email'];

 					$c_address = $row_data['customer_address'];

 					$c_contact = $row_data['customer_contact'];


 					echo "<center><h2 style='font-family: Arial, Helvetica, sans-serif' >Welcome $c_name!</h2></center>";

 					echo "<h4 style='font-family: Arial, Helvetica, sans-serif; padding-left: 20px' >Email: $c_email</h2>";

 					echo "<h4 style='font-family: Arial, Helvetica, sans-serif; padding-left: 20px' >Address: $c_address</h2>";

 					echo "<h4 style='font-family: Arial, Helvetica, sans-serif; padding-left: 20px' >Contact: $c_contact</h2>";
