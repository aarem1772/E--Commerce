			...
			<hr style="margin:0; height:2px; background-color: black; border:none">
				...
				<div class="navbar">
					...
					<?php
						...
						<h2 style="text-align: center; font-family: Arial, Helvetica, sans-serif;">Confirm Delete your Account!</h2>

					<form action="delete_account.php" method="post" enctype="multipart/form-data" style="font-family: Arial, Helvetica, sans-serif;">

						
						<center><input type = "submit" name="delete_account" value = "Delete Your Account"></center>						
...
<?php
					...
					if(isset($_POST['delete_account']))
					{
						...
						{*/
							$update_delacc =  "DELETE FROM customers WHERE customer_id='$user'";
							$run_update = mysqli_query($con, $update_delacc);
							session_destroy();

							

							echo "<script>alert('Your Account was deleted successfully!')</script>";
