			...
			<hr style="margin:0; height:2px; background-color: black; border:none">
				...
				<div class="navbar">
					...
					<?php
						...
						<h2 style="text-align: center; font-family: Arial, Helvetica, sans-serif;">Change your Registered Address</h2>

					<form action="change_address.php" method="post" enctype="multipart/form-data" style="font-family: Arial, Helvetica, sans-serif;">

						<b style="padding-left: 500px">Enter New Address: </b><input type = "text" name = "new_address" ><br>
						...
						<br>
						<br>
						<center><input type = "submit" name="change_address" value = "Change Address"></center>						
...
<?php
					...
					$old_address = $_SESSION['customer_address'];	
					if(isset($_POST['change_address']))
					{
						...
						/*$sel_address = "select * from customers where customer_id='$user'";
						$run_address = mysqli_query($con,$sel_address);
						...
						{*/
							$update_address = "update customers set customer_address='$new_address' where customer_id='$user'";

							$run_update = mysqli_query($con, $update_address);

							

							echo "<script>alert('Your Address was updated successfully!')</script>";
							echo "<script>alert('old address: $old_address')</script>";
							echo "<script>alert('new address: $new_address')</script>";
